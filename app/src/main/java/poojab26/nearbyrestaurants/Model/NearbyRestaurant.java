...
public class NearbyRestaurant {
    ...
    @Expose
    private poojab26.nearbyrestaurants.Model.UserRating userRating;
    ...
    public poojab26.nearbyrestaurants.Model.UserRating getUserRating() {
        return userRating;
    }

    public void setUserRating(poojab26.nearbyrestaurants.Model.UserRating userRating) {
